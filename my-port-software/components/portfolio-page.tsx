              ...
              <div key={category} className="mb-20">
                ...
                <div className="space-y-4">
                  {skillList.map((skill, index) => (
                    ...
                    >
                      <h4 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black tracking-tighter text-black satoshi-black hover:text-gray-700 transition-colors cursor-default">
                        {skill}
                      </h4>
                    </motion.div>
                  ))}
